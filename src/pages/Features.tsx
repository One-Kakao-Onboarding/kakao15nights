  ...
  return (
    <div className='min-h-screen bg-gradient-radial'>
          ...
          <div className='max-w-4xl mx-auto space-y-16'>
            ...
            <div className='grid md:grid-cols-2 gap-8 items-center'>
              <div>
                ...
                <p className='text-gray-400 mb-4'>
                  마치 선배 디자이너가 빨간펜으로 피드백을 주듯, AI가 발견한 UX 문제점을 원본 이미지
                  위에 직관적으로 표시합니다.
                </p>
            ...
            <div className='grid md:grid-cols-2 gap-8 items-center'>
              ...
              <div className='order-1 md:order-2'>
                ...
                <p className='text-gray-400 mb-4'>
                  한 번의 분석으로 다양한 사용자 관점의 피드백을 받아보세요. 각 페르소나는 고유한
                  특성과 UX 체크리스트를 가지고 있습니다.
                </p>
                <ul className='space-y-2 text-sm text-gray-400'>
                  <li className='flex gap-2'>
                    <span className='text-white'>•</span>
            ...
            <div className='grid md:grid-cols-2 gap-8 items-center'>
              <div>
                ...
                <p className='text-gray-400 mb-4'>
                  각 페르소나는 특별한 시각화 기능을 제공합니다. 사용자의 시점에서 UI가 어떻게
                  보이는지 직접 체험해보세요.
                </p>
                <ul className='space-y-2 text-sm text-gray-400'>
                  <li className='flex gap-2'>
      ...
      <section className='container mx-auto py-24 px-4 text-center'>
        ...
        <p className='text-gray-400 mb-8'>UI 스크린샷 한 장으로 시작할 수 있습니다.</p>
        <Link to='/analyze'>
